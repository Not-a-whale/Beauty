// get our elements
const slider = document.querySelector('.just-dropped__slider');
const slides = Array.from(document.querySelectorAll('.just-dropped__container'));
const slideNodes = document.querySelectorAll('.just-dropped__container');
